package fotistsiou.java.tic_tac_toe.step_1;

/**
 * Welcome to the battlefield!
 * ---------------------------
 * Description
 * Tic-tac-toe is a game known all over the world.
 * Each country may have its own version of the name, sometimes the rules are different, but the essence of the game remains the same.
 ...
 * Use what you’ve learned about the print() function to print three lines, each containing three characters (X’s and O’s)
